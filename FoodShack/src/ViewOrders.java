...
public class ViewOrders extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Address", "Order Food", "Order Beverages", "Payment", "Contact No."
            }
        ) {
        ...
        jButtonLogin.setText("Order Now");
        ...
        jLabel2.setText("Orders from Customers");
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        OrderForm ofm = new OrderForm();
        ofm.setVisible(true);
        ofm.pack();
        ofm.setLocationRelativeTo(null);
        ofm.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
